...
public class QuorabayFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Api Call
        Call<List<Questions>> questionApiCall = iPostAPI.getQuestionByCategoryId("c5");
        questionApiCall.enqueue(new Callback<List<Questions>>() {
            ...
            public void onResponse(Call<List<Questions>> call, Response<List<Questions>> response) {
                ...
                QuorabayQuestionsRecylerViewAdapter recyclerViewAdapter = new QuorabayQuestionsRecylerViewAdapter(questionsList, QuorabayFoodActivity.this);
                recyclerView.setLayoutManager(new LinearLayoutManager(QuorabayFoodActivity.this));

...
public class QuorabayTechnologyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quorabay_technology2);

        String userId = getIntent().getStringExtra("QuorabayUserId");
        String userName = getIntent().getStringExtra("QuorabayUserName");

        List<Questions> questionsList = new ArrayList<>();
        RecyclerView recyclerView = findViewById(R.id.quorabay_technology_recycler_view);
        ...
        questionApiCall.enqueue(new Callback<List<Questions>>() {
            ...
            public void onResponse(Call<List<Questions>> call, Response<List<Questions>> response) {
                ...
                QuorabayQuestionsRecylerViewAdapter recyclerViewAdapter = new QuorabayQuestionsRecylerViewAdapter(questionsList, QuorabayTechnologyActivity.this);
                recyclerView.setLayoutManager(new LinearLayoutManager(QuorabayTechnologyActivity.this));
